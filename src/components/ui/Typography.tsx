...
const typographyVariants = cva("font-nunito", {
  variants: {
    variant: {
      ...
      "heading-lg":
        "text-[60px]/17 font-(--font-weight) tracking-normal [--font-weight:700]",
      "heading-md":
        "text-[48px] leading-none font-(--font-weight) tracking-tighter [--font-weight:700]",

      "title-lg":
        "text-[32px]/10 font-(--font-weight) tracking-normal [--font-weight:700]",
      "title-md":
        "text-[24px]/8 font-(--font-weight) tracking-wide [--font-weight:700]",
