...
const OrderCardThumbnail = ({
  ...
  <Image
    ...
    alt={alt} //fucking nextjs eslint a11y rule
    {...props}
  />
);
...
const OrderCardTitle = ({
  ...
  return (
    <Comp
      className={cn(
        typographyVariants({ variant: "body-md" }),
        "min-w-0 font-normal",
        className,
      )}
...
const OrderCardBadges = ({
  ...
  return (
    <Comp
      className={cn(
        "flex min-h-8 w-full flex-wrap items-start gap-2",
        className,
      )}
